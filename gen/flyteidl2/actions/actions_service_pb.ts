...
import type { ActionIdentifier } from "../common/identifier_pb";
import { file_flyteidl2_common_identifier } from "../common/identifier_pb";
import type { EnrichedIdentity } from "../common/identity_pb";
import { file_flyteidl2_common_identity } from "../common/identity_pb";
import type { Literal } from "../core/literals_pb";
import { file_flyteidl2_core_literals } from "../core/literals_pb";
import type { RunSpec } from "../task/run_pb";
import { file_flyteidl2_task_run } from "../task/run_pb";
import type { ActionStatus, ConditionAction, TaskAction, TraceAction } from "../workflow/run_definition_pb";
import { file_flyteidl2_workflow_run_definition } from "../workflow/run_definition_pb";
import type { ActionUpdate, ControlMessage } from "../workflow/state_service_pb";
import { file_flyteidl2_workflow_state_service } from "../workflow/state_service_pb";
...
export const file_flyteidl2_actions_actions_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_flyteidl2_common_identifier, file_flyteidl2_common_identity, file_flyteidl2_core_literals, file_flyteidl2_task_run, file_flyteidl2_workflow_run_definition, file_flyteidl2_workflow_state_service]);
...
export type AbortRequest = Message<"flyteidl2.actions.AbortRequest"> & {
   ...
   *
   * @generated from field: optional flyteidl2.common.EnrichedIdentity aborted_by = 3;
   */
...
export type SignalRequest = Message<"flyteidl2.actions.SignalRequest"> & {
   ...
   * replication; the full identity is re-enriched on read.
   *
   * @generated from field: optional flyteidl2.common.EnrichedIdentity signalled_by = 4;
   */
