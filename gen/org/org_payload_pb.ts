...
/**
 * @generated from message cloudidl.org.EnsureTunnelDNSRequest
 */
export type EnsureTunnelDNSRequest = Message<"cloudidl.org.EnsureTunnelDNSRequest"> & {
  /**
   * Organization whose Union-managed tunnel DNS delegation should exist.
...
/**
 * Describes the message cloudidl.org.EnsureTunnelDNSRequest.
 * Use `create(EnsureTunnelDNSRequestSchema)` to create a new message.
 */
export const EnsureTunnelDNSRequestSchema: GenMessage<EnsureTunnelDNSRequest> = /*@__PURE__*/
  messageDesc(file_org_org_payload, 12);

/**
 * @generated from message cloudidl.org.EnsureTunnelDNSResponse
 */
export type EnsureTunnelDNSResponse = Message<"cloudidl.org.EnsureTunnelDNSResponse"> & {
  /**
   * Number of DNS records that were created.
   *
   * @generated from field: int32 records_added = 1;
   */
  recordsAdded: number;

  /**
   * Number of existing DNS records that were updated.
   *
   * @generated from field: int32 records_modified = 2;
   */
  recordsModified: number;
};

/**
 * Describes the message cloudidl.org.EnsureTunnelDNSResponse.
 * Use `create(EnsureTunnelDNSResponseSchema)` to create a new message.
 */
export const EnsureTunnelDNSResponseSchema: GenMessage<EnsureTunnelDNSResponse> = /*@__PURE__*/
